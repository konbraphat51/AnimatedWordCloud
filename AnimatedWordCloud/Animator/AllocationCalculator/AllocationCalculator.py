...
from AnimatedWordCloud.Utils import AllocationTimelapse, TimelapseWordVector, Config
...
def allocate(
    ...
    static_allocation_timelapse = allocate_static(word_vector_timelapse, config)
